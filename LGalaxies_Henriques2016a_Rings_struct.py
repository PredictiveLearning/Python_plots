...
('MetalsColdGasRings',np.float32,[12,1]),  
('MetalsStellarMass',np.float32,1),
('MetalsDiskMass',np.float32,1),
('MetalsBulgeMass',np.float32,1),
('MetalsDiskMassRings',np.float32,[12,1]),  
('MetalsBulgeMassRings',np.float32,[12,1]),  
...
('sfh_MetalsDiskMass',np.float32,[20,1]),
('sfh_MetalsBulgeMass',np.float32,[20,1]),
('sfh_MetalsICM',np.float32,[20,1]),        
