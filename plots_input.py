...
RedshiftsToRead = [True,False, False,True,True,True,False, False]
...
opt_stellar_mass_vs_halo_mass_fractional=1
opt_stellar_mass_function_z0_overplot=0
opt_stellar_mass_function_feedback_overplot=0
...
#MCMCSampledir = '/net/bootes//export/data1/Workspace/31/output/task0_'
#MCMCSampledir = '/net/bootes//export/data1/Workspace/cosma/task0_'
#MCMCSampledir = '/net/bootes/export/data1/Workspace/cosma/output57/final_'
...
#DirName_MR = '/net/bootes/scratch-ssd/SAM/test0/MR/'
#DirName_MR = '/net/bootes/scratch2/SAM/Henriques2015a/snaps/Guo10/MR/'
...
if PLANCK: 
    FullRedshiftList=[0.00,0.11,0.40,1.04,2.07,3.11,3.95,5.03] 
    FullSnapshotList_MR=[58,54,47,38,30,25,22,19]
    ...
    FullSnapshotList_MRII=[62,58,51,42,34,29,26,23]
