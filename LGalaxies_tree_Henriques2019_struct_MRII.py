...
('Type',np.int32,1),
#('HaloM_Mean200',np.float32,1),
#('HaloM_Crit200',np.float32,1),
#('HaloM_TopHat',np.float32,1),
#('HaloPos',np.float32,3),
#('HaloVel',np.float32,3),
#('HaloVelDisp',np.float32,1),
#('HaloVmax',np.float32,1),
...
('sfh_ElementsDiskMass',np.float32,[20,5]),
('sfh_ElementsBulgeMass',np.float32,[20,5]),
('sfh_ElementsICM',np.float32,[20,5]),
('DiskMass_elements',np.float32,5),
('BulgeMass_elements',np.float32,5),
('DiskMassRings_elements',np.float32,[12,5]),        
('BulgeMassRings_elements',np.float32,[12,5]),    
('ColdGas_elements',np.float32,5),
('ColdGasRings_elements',np.float32,[12,5]),        
('HotGas_elements',np.float32,5),
('ICM_elements',np.float32,5),
('EjectedMass_elements',np.float32,5)        
])
